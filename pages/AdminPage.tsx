  ...
  const handleSaveSettings = async () => {
    ...
    if (ok) {
      ...
      alert('Settings saved and synced to cloud');
        ...
        // Fallback save to local if cloud fails (e.g. API key change offline)
        onSaveSettings(localSettings);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="glass-card p-6 md:p-10 flex flex-col gap-8 h-fit">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-1 mt-2">
                    <p className="text-[8px] text-gray-400">
                      * API Key is now managed via Vercel Environment Variables.
                    </p>
                    {localSettings.selectedModel?.includes('pro') && (
                      <p className="text-[8px] text-yellow-500">
                        Warning: Pro model requires a Billing-enabled Google Cloud Project.
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-[8px] text-gray-600 mt-1">Use this if your camera is mounted sideways.</p>
                </div>
